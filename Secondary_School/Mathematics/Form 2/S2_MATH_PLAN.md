...
- **41_Modelling_Cycle** (new): interactive 6-stage modelling cycle with MTR passenger-flow linear rate model; bilingual; NSE enrichment (societal resilience).
- Suite plan: `../MODELLING_AI_NSE_PLAN.md`.
