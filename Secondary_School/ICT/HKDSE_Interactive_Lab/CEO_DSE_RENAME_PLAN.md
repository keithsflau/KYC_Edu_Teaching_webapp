# CEO DSE Past Paper Rename Plan

**Authority:** Agent 01/10 inventory. Sibling agents MUST follow this map exactly.  
**Scope:** `HKDSE_Interactive_Lab/2025` and `HKDSE_Interactive_Lab/Long_Questions` only.  
**Date:** 2026-07-29
...
- **Zero-pad** question numbers 1–9 as `Q01`–`Q09`; use `Q10+` without extra padding.
...
- Folder rename only; titles stay human-readable, e.g. `HKDSE 2025 Paper 1A Q28 - 流程圖追蹤器`.
...
|------|----------------|-------|
| `2025` | Paper 1A apps (Q1–Q40, incl. combined) | 40 |
| `2025` | Paper 1B apps (Q1–Q11) | 11 |
| `2025` | Paper 2 apps (Q1–Q4) | 4 |
...
| `P1A_Q28` | `DSE_2025_P1A_Q28_Flowchart_Tracer` | HKDSE 2025 Paper 1A Q28 - 流程圖追蹤器 |
| `P1A_Q29` | `DSE_2025_P1A_Q29_Flowchart_M1_M2` | HKDSE 2025 Paper 1A Q29 - 流程圖 M1 vs M2 |
